        ...
        <>
            ...
            <article>
                ...
                <div class="flex items-center mb-1">
                    ...
                    <h3 class="ml-2 text-sm font-semibold text-gray-900">{heading}!</h3>
                </div>
                ...
                <p class="mb-2 font-light text-gray-500 ">{comment}</p>
                <p class="mb-3 font-light text-gray-500 ">{footer}.</p>
            </article>
