  ...
  if (loading) {
    ...
    return (
      <motion.div
        ...
        <img className="h-96 w-auto" src="./images/loading.gif" alt="loading"/>
    ...
    return (
      <>
        <motion.div
          ...
          <div class="flex flex-col items-center">
              <span class="text-sm text-gray-700 dark:text-gray-400">
                Showing <span class="font-semibold text-gray-900 text-black">{currentPage}</span> to <span class="font-semibold text-gray-900 text-black">{pageSize}</span> of <span class="font-semibold text-black text-gray-900">{products.indianfood.length}</span> Entries
              </span>
              <div class="inline-flex mt-2 xs:mt-0">
                {currentPage > 1 && (
                  <button onClick={handlePreviousClick} class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-gray-800 rounded-l hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
